    ...
    <section id="skills" className="py-20 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {Object.entries(skillsByCategory).map(([category, skills]) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              whileHover={{ y: -5, boxShadow: '0 10px 25px -5px rgba(111, 207, 207, 0.2)' }}
            >
              ...
              >
                {skills.map((skill) => (
                  <motion.div
                    ...
                    variants={item}
                    whileHover={{ scale: 1.05, backgroundColor: 'rgba(111, 207, 207, 0.1)' }}
                  >
                    {skill.icon && (
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h3 className="text-xl font-bold mb-6 text-center">Proficiency Overview</h3>
